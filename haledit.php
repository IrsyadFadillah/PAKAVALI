...
<?php
  ...
  $id = $_GET['id'];
  $result = mysqli_query($koneksi, "select * from konser where id='$id'");
  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <div class="login-content">
            <form action="scriptedit.php" method="POST">
              <div class="input-div one">
                <div class="div">
                    <label for="Nama_Konservasi">Nama Lokasi Konservasi</label>
                    <input type="text" class="form-control" name="Nama_Konservasi" value=<?= $row['Nama_Konservasi'] ?> placeholder="Nama Lokasi Konservasi">
                </div>
              </div>
              <div class="input-div pass">
                <div class="div">
                  <label for="Status_Konservasi">Status Konservasi</label>
                  <input type="text" class="form-control" name="Status_Konservasi" value=<?= $row['Status_Konservasi'] ?> placeholder="Status Konservasi">
                </div>
              </div>
              <div class="input-div pass">
                <div class="div">
                    <label for="Titik_Koordinat">Titik Koordinat</label>
                    <input type="text" class="form-control" name="Titik_Koordinat" value=<?= $row['Titik_Koordinat'] ?> placeholder="Titik Koordinat">
                </div>
              </div>
              <div class="input-div pass">
                <div class="div">
                    <label for="Deskripsi">Deskripsi</label>
                    <input type="text" class="form-control" name="Deskripsi" value=<?php echo $row['Deskripsi'] ?> placeholder="Deskripsi">
                </div>
              </div> 
              <br>
              <input type="hidden" value="<?php echo $id; ?>" name="id">
              <input type="submit" class="button btn-primary" value="Simpan" />
            </form>
          </div>
      </div>
		</div>
